...
**Central question:** How do soils form, store water, erode and weather, and change their physical behaviour as composition and water content vary?

## Study Path

1. [[01 - Main Definitions]]
2. [[02 - 8.1 Introduction to Soils and Phase Relationships]]
3. [[03 - 8.2 Soil Erosion, Degradation, and Weathering Processes]]
4. [[04 - 8.3 Characterizing Soils and Soil Plasticity]]
5. [[99 - Quiz Bank]]
...
- Erosion generally becomes more effective as the velocity of water, wind, or ice increases. Windbreaks, reduced or contoured slopes, and terraces limit topsoil loss.
- The course applies the Unified Soil Classification System through colour, texture, structure, and pH.
- Porosity measures empty space; permeability measures how readily water moves through soil. They are related ideas, not synonyms.
- Soil consistency progresses with decreasing water content from liquid to plastic to semi-solid to solid. The liquid, plastic, and shrinkage limits separate these states.
- The plasticity index is the liquid limit minus the plastic limit. A small index means only a small water-content change is needed to reach liquid behaviour.

## Equations and Quantitative Skills

$$
n=\frac{V_{\text{voids}}}{V_{\text{total}}}
\qquad
e=\frac{V_{\text{voids}}}{V_{\text{solids}}}
$$

$$
w=\frac{m_{\text{water}}}{m_{\text{solids}}}
\qquad
S_r=\frac{V_{\text{water}}}{V_{\text{voids}}}
$$
