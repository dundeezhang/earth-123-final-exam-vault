...
2. Which statement best describes the water table?
...
3. Which aquifer is bounded by a semi-permeable layer that permits limited groundwater exchange?
   - A. Unconfined
   - B. Confined
   - C. Semi-confined
   - D. Karst

4. In which aquifer type does the course expect the fastest water transmission?
   - A. Unconfined
   - B. Confined
   - C. Semi-confined
   - D. Karst

5. Which aquifer does the course identify as the preferred freshwater source for human use?
   - A. Confined
   - B. Unconfined
   - C. Karst
   - D. Perched

6. What is the main groundwater role of a sand-and-gravel moraine?
...
7. A shallow well finds a small saturated lens, but another nearby well at the same depth is dry. Which feature best explains this?
   - A. Flow-through stream
   - B. Confined regional aquifer
   - C. Perched water table
   - D. Potentiometric surface

8. Which material in Table 9.3.1 has the highest specific yield?
   - A. Clay
   - B. Sand
   - C. Gravel
   - D. Limestone

9. Which material in Table 9.3.1 has the highest specific retention?
   - A. Clay
   - B. Sand
   - C. Gravel
   - D. Basalt

10. In homogeneous geology, groundwater flow lines cross equipotential contours at what angle?
   - A. $0^\circ$
   - B. $30^\circ$
   - C. $45^\circ$
   - D. $90^\circ$
...
12. Which stream receives groundwater while its surface meets the water table?
   - A. Losing stream
   - B. Gaining stream
   - C. Perched stream
...
14. An unconfined aquifer is generally more vulnerable to surface contamination than a confined aquifer.

15. High porosity always means high permeability.

16. Piezometer arrays can be used to estimate hydraulic gradient and determine whether groundwater levels are rising or falling.

17. Darcy specific discharge and pore-water velocity are identical even when porosity is less than 1.
...
|---|---|
| 1. Aquitard | A. Water retained after gravity drainage |
| 2. Specific yield | B. Surface to which confined water can rise |
| 3. Specific retention | C. Very-low-permeability layer that restricts flow |
...
21. Give two reasons karst aquifers are risky for water supply or infrastructure.

22. Explain how clay can have 50% porosity but only 2% specific yield.

23. What three kinds of groundwater information can a piezometer network provide?

24. Distinguish hydraulic head from hydraulic gradient.

25. List four contamination sources or pathways identified in section 9.5.

26. Describe the four groundwater-stream interactions shown in Figure 9.5.2.
...
29. At the same site, the well bottom is $384\ \text{m}$ and hydraulic head is $398\ \text{m}$. Calculate pressure head and water pressure using $\rho=1000\ \text{kg/m}^3$ and $g=9.81\ \text{m/s}^2$. Give pressure in Pa and kPa.

30. Wells A and C have hydraulic heads of $398\ \text{m}$ and $395\ \text{m}$ and are $100\ \text{m}$ apart. Calculate hydraulic gradient magnitude and state flow direction.

31. For the A-to-C interval, use $K=2.16\ \text{m/day}$ and $i=0.030$ to calculate Darcy specific discharge. Then use $n=0.25$ to calculate pore-water velocity.

32. Using the velocity from Question 31, calculate travel time over $100\ \text{m}$.

33. A landfill plume moves through material with $K=10^{-4}\ \text{m/s}$, $n=0.35$, and a head drop of $2\ \text{m}$ over $100\ \text{m}$. Calculate the velocity magnitude and give the course's approximate daily speed and $100\ \text{m}$ travel time.
...
1. **B. Percolation.** The retained water-cycle figure labels percolation as continued subsurface flow toward groundwater. *(§9.1, “Groundwater in the hydrological cycle,” reconstructed from local assets.)*

2. **B.** The water table is the upper surface of the saturated groundwater zone. *(§9.1, “Groundwater in the hydrological cycle”; §9.3, “Water-table controls on movement.”)*

3. **C. Semi-confined.** Its semi-permeable boundary allows limited leakage. *(§9.2, “Semi-Confined Aquifer.”)*

4. **D. Karst.** Large cracks, fractures, voids, and tunnels permit rapid, long-distance flow. *(§9.2, “Karst Aquifers”; course Check Your Knowledge.)*

5. **A. Confined.** The course identifies confined aquifers as protected from surface contamination and preferred for human drinking water. *(§9.2, “Confined Aquifer”; course Check Your Knowledge.)*

6. **B.** Moraines store infiltrating precipitation and snowmelt and channel groundwater to lower-elevation springs, streams, and rivers. *(§9.2, “The Glacial Connection,” Figures 9.2.5-9.2.6.)*

7. **C. Perched water table.** A local aquitard can hold a discontinuous saturated lens above the regional table. *(§9.3, “Perched water tables,” Figure 9.3.2.)*

8. **B. Sand.** Table 9.3.1 gives sand a 22% specific yield, the largest listed. *(§9.3, “Specific yield, retention, and permeability,” Table 9.3.1.)*

9. **A. Clay.** Table 9.3.1 gives clay 48% specific retention. *(§9.3, “Specific yield, retention, and permeability,” Table 9.3.1.)*
...
13. **False.** The retained 9.1 regional figure shows groundwater in pores of gravel, granular aquifers, and fractured rock. *(§9.1, “Reading a groundwater system,” reconstructed from local assets.)*

14. **True.** An unconfined aquifer is open to near-surface recharge and contamination, whereas an aquitard protects a confined aquifer. *(§9.2, “Unconfined Aquifer” and “Confined Aquifer.”)*

15. **False.** Clay has high porosity but low permeability because its tiny pores are poorly connected. *(§9.3, “Specific yield, retention, and permeability.”)*
...
19. **1-C, 2-D, 3-A, 4-B, 5-E.** *(§9.2, “Confined Aquifer”; §9.3, “Specific yield, retention, and permeability”; §9.4, “Head and pressure”; §9.5, “Four stream interactions.”)*

20. **Infiltration is water entering the ground from the surface; percolation is continued downward subsurface drainage toward the water table or saturated zone.** *(§9.1, “Groundwater in the hydrological cycle”; Week 9 glossary, “Percolation.”)*

21. **Any two:** rapid contaminant movement from surface to depth, long-distance contaminant transport, collapse/cave-in risk during drilling, or risk to buildings and infrastructure. *(§9.2, “Karst Aquifers.”)*

22. **Clay contains many very small pores, but they are poorly connected and retain water strongly; thus it has 50% porosity, 48% retention, and only 2% yield.** *(§9.3, “Specific yield, retention, and permeability,” Table 9.3.1.)*

23. **Water-table elevation/depth, hydraulic gradient, and whether groundwater levels are stable, rising, or falling.** *(§9.3, “Piezometers and water-table behaviour,” Figures 9.3.3-9.3.4.)*

24. **Hydraulic head is water's potential-energy elevation at a point; hydraulic gradient is the change in head divided by distance between points.** *(§9.4, “Head and pressure” and “Hydraulic gradient”; Week 9 glossary.)*

25. **Any four:** agricultural/septic bacteria or viruses, fertilizer nutrients, saltwater incursion, road salt, industrial chemicals/disposal, pesticides, or pharmaceuticals. *(§9.5, “Contamination pathways,” Figure 9.5.3.)*

26. **Gaining:** groundwater enters the stream. **Losing:** stream water infiltrates while flow remains. **Losing above a perched/separated table:** slower leakage enters the unsaturated zone and moves away. **Flow-through:** groundwater enters one side and exits the lower-gradient side. *(§9.5, “Four stream interactions,” Figure 9.5.2.)*

27. **Heavy rain from May 8-12, 2000 moved freshly spread manure from farmland in runoff; open Well #5 admitted contaminated surface water; karst cracks and fractures connected that surface aquifer to the deeper, actually semi-confined aquifers supplying Wells 6 and 7.** *(§9.6, “Surface source and entry point” and “Subsurface pathway.”)*

28. **$398\ \text{m}$.** $425-27=398\ \text{m}$. *(§9.4, “Course worked values: Wells A, B, and C,” Assignment 5, Question 2a.)*

29. **Pressure head $=14\ \text{m}$; pressure $=137{,}340\ \text{Pa}=137.34\ \text{kPa}$.** $h_p=398-384=14\ \text{m}$; $p=(1000)(9.81)(14)$. *(§9.4, “Course worked values: Wells A, B, and C,” Assignment 5, Question 2a.)*

30. **$i=0.030$, from A to C.** $(398-395)/100=0.030$; A has the higher head. *(§9.4, “Course worked values: gradient, discharge, velocity, and travel,” Assignment 5, Question 2b.)*

31. **$q=0.0648\ \text{m/day}$; $v=0.2592\ \text{m/day}=25.92\ \text{cm/day}$.** $q=(2.16)(0.030)$ and $v=0.0648/0.25$. *(§9.4, “Course worked values: gradient, discharge, velocity, and travel,” Assignment 5, Questions 2c-2d.)*

32. **$385.8\ \text{days}$.** $t=100/0.2592$. *(§9.4, “Course worked values: gradient, discharge, velocity, and travel,” Assignment 5, Question 2d.)*
