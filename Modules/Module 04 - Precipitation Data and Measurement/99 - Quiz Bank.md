...
2. Which statement best distinguishes a Primary Network from a Co-operative Network?
...
3. Which instrument directly measures precipitation-particle size, shape, velocity, and intensity?
   - A. Float gauge
...
5. Under the course placement rule, how far should a gauge be from the nearest 3 m tall object?
   - A. At least 0.75 m
   - B. At least 3 m
   - C. At least 7 m
   - D. At least 12 m

6. What is the main purpose of Nipher-type and Alter-type gauge shields?
...
7. Why is a standard non-recording snow gauge commonly raised about 1 m above the ground?
...
8. Point A lies between 0.75 and 0.80 cm isohyets in Figure 4.3.1. What estimate does the course give for A?
   - A. 0.70 cm
   - B. 0.75 cm
   - C. 0.78 cm
   - D. 0.85 cm

9. Which areal estimation method assigns each gauge a weight based on the fraction of the total area contained in its polygon?
   - A. Arithmetic average
   - B. Missing-station normalization
   - C. Thiessen Polygon Method
   - D. Snow-core method

10. In which setting is the arithmetic average most likely to be reasonably accurate?
...
12. A non-recording gauge can produce rainfall intensity without any time-resolved observations.

13. Increasing the gauge opening size tends to reduce catch deficiency from oblique rainfall.

14. Wind can make the final areal distribution of snow unrepresentative of the snow that originally fell at a point.

15. A sudden change in a station's plotted trend after relocation necessarily proves that the regional climate changed abruptly.
...
| Issue | Response |
|---|---|
| A. Evaporation from a non-recording collector | 1. Add a wind shield near the opening |
| B. Wind under-catch | 2. Use a thin oil film or reflective outer shell |
| C. Burial of a snow gauge | 3. Elevate it to about 1 m or higher |
| D. Nearby 5 m obstacle | 4. Place the gauge at least 20 m away |

19. Match each analysis goal to its method.

| Goal | Method |
|---|---|
| A. Estimate one failed station from nearby stations and long-term normals | 1. Arithmetic average |
| B. Give every included gauge equal weight | 2. Adjustment factor |
...
21. Give two disadvantages of a non-recording rain gauge.

22. Distinguish wind under-catch from evaporation loss.

23. Why is water equivalent more useful than snow depth alone for anticipating flooding or increased river flow?
...
27. A target station has normal annual precipitation $N_x=52$ cm. Three nearby stations have $(P_i,N_i)$ pairs of $(40,45)$, $(58,65)$, and $(37,40)$ cm. Use $P_x=\dfrac{N_x}{3}\sum(P_i/N_i)$ to estimate the missing annual precipitation.

28. A station comparison has a slope of 0.98 before relocation and 0.65 after relocation. Calculate the adjustment factor $K$ and state how it is used to put the old data on the new basis.

29. A $25\ \text{m}^2$ belt lies between the 4.0 and 4.5 cm isohyets. Calculate its mean precipitation depth in metres and its precipitation volume in cubic metres.
