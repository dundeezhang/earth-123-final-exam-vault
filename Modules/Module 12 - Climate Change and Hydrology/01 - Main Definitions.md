...
|---|---|---|---|
| Climate | Long-term atmospheric pattern; the course uses at least 3 decades (30 years). | 12.1 | A 30-year record of earlier snowmelt and shorter lake-ice seasons can establish a climate pattern. |
| Weather | Month-to-month or year-to-year atmospheric change. | 12.1 | One cold snap or one unusually snowy winter is weather evidence, not a climate trend. |
| Climate change | Change in climate measured over at least 30 years. | 12.1 | Earlier snowmelt and increased annual high-latitude runoff are hydrologic evidence when sustained across decades. |
| Global warming | Increase in average global temperature. | 12.1, 12.2 | The course reports that anthropogenic warming since the Industrial Revolution has nearly reached $+1.5^\circ\mathrm{C}$. |
| Greenhouse gas | Gas that impedes radiant heat from escaping Earth to space. | 12.1 | CO$_2$ and CH$_4$ from industry, energy, and transportation are the dominant examples examined in the course. |
| Greenhouse effect | Warming that occurs when atmospheric greenhouse gases trap outgoing radiant heat. | 12.1 | Added CO$_2$ leaves more energy in the atmosphere, raising air, land, and sea temperatures. Saved Quiz 12 uses approximately $+3^\circ\mathrm{C}$, with about $\pm1^\circ\mathrm{C}$ uncertainty, for doubled current CO$_2$. |
...
| Diurnal temperature range | Difference between daytime and nighttime temperature. | 12.1 | From 1979 to 2004, the range changed little because daily maxima and minima rose at similar rates. |
| Proxy data | Indirect evidence used when direct measurements of past climate are unavailable. | 12.2 | Scientists infer past climate from $^{18}\mathrm{O}/^{16}\mathrm{O}$ ratios in fossil marine shells. |
| Ice core | Cylindrical ice sample containing layered ice and trapped ancient air used to reconstruct past atmospheres. | 12.2 | Greenland and Antarctic cores preserve air bubbles used to extend CO$_2$ records back 800,000 years. |
| Keeling Curve | Long-running record of atmospheric CO$_2$, beginning in 1958 at Mauna Loa, showing an upward trend and seasonal cycle. | 12.2 | Its annual saw-tooth tracks Northern Hemisphere vegetation atop the rise to nearly 420 ppm by July 2022. |
| Parts per million, ppm | Concentration unit used for trace atmospheric gases such as CO$_2$. | 12.2 | The course compares nearly 420 ppm in July 2022 with a preindustrial level of about 280 ppm. |
| Climate model | Computer representation used to compare observations with natural-only and combined natural-plus-human causes. | 12.2 | Natural-only runs miss observed modern warming; natural-plus-human runs match it much more closely. |
...
| IPCC | Intergovernmental Panel on Climate Change, a UN-created international group established in 1988 to organize scientists and share climate knowledge. | 12.3 | Its 195 member countries synthesize research to project futures under continued-emission scenarios and report confidence despite short-term uncertainty. |

## Commonly Confused Terms

- **Weather vs. climate:** weather is short term; climate requires a record of at least 30 years.
- **Cause vs. response:** orbital changes and greenhouse gases can drive climate; ice loss and more severe atmospheric hazards are responses.
- **CO$_2$ level vs. temperature:** they are distinct measured variables linked through physical processes.
