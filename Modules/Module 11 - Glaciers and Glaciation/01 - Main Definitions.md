...
| Cirque glacier | Small ice mass confined entirely to a bowl-shaped or amphitheatre-like cirque. | 11.1, Formation of Glaciers | It appears as a small ice patch occupying the amphitheatre-shaped hollow at a valley head. |
| Valley glacier | Glacier originating in a cirque, ice cap, or valley head and flowing downslope between valley walls. | 11.1, Formation of Glaciers | Tributary ice streams can join a larger flow that remains confined between two valley walls. |
| Continental glaciation | Large-scale glaciation over continental land masses, especially in polar regions. | 11.1, Formation of Glaciers | Greenland and Antarctica are the course's modern continental-glaciation settings. |
| Ice sheet | Very large mass of glacial ice not confined by topographic obstacles. | 11.1, Formation of Glaciers | The Antarctic ice sheet obscures nearly all underlying surface features, including smaller mountains. |
| Zone of accumulation | Higher-elevation glacier region where winter snow and ice persist through the warmer summer months. | 11.1, Anatomy of a Glacier | On the course's valley-glacier cross-section, this is the upper area above the equilibrium line. |
...
| Moraine | Unsorted, unconsolidated mass or pile of sediment deposited during glacier advance and recession. | 11.3, Depositional Features in Alpine Glacier Environments | A ridge left after ice recedes can mark a former glacier side, centre line, or toe. |
| Glacial till | Newly deposited, unsorted and unconsolidated material that forms moraines. | 11.3, Depositional Features in Alpine Glacier Environments | Mixed, unsorted sediment in a lateral, medial, or terminal ridge is identified as till. |
| Lateral moraine | Elongated low mound of till beside a valley glacier, parallel to ice flow, produced by abrasion against valley walls. | 11.3, Depositional Features in Alpine Glacier Environments | In Figure 11.3.1, two low debris ridges trace the glacier's outer sides downslope. |
| Medial moraine | Central or near-central dark sediment strip formed when two or more lateral moraines merge with joining ice flows. | 11.3, Depositional Features in Alpine Glacier Environments | A dark stripe appears near the ice centre below the junction of two tributary glaciers. |
| Terminal or end moraine | Large sediment accumulation left at a glacier's toe when expansion stops. | 11.3, Depositional Features in Alpine Glacier Environments | A large till ridge across a valley marks the glacier's former maximum front. |
| Recessional moraine system | Series of adjacent end or terminal moraines produced by repeated recession and deposition. | 11.3, Depositional Features in Alpine Glacier Environments | Several parallel ridges record successive pauses during retreat. |
| U-shaped valley | Broad glacially carved valley whose shape records the bulldozing action of moving ice. | 11.3, Erosional Features in Alpine Glacier Environments | A broad floor and steep sides replacing a stream-cut V profile are a strong sign of past glaciation. |
| Hanging valley | Upper tributary valley left above a glacially deepened U-shaped valley, commonly with a steep drop-off. | 11.3, Erosional Features in Alpine Glacier Environments | A tributary valley ending high on the main valley wall may produce a waterfall over the drop. |
| Cirque | Steep-sided, bowl-like or amphitheatre-like recess carved at the head of a glacial valley. | 11.3, Erosional Features in Alpine Glacier Environments | Snow, ice, or water may occupy the base of the bowl at a valley head. |
| Arete | Sharp ridge, often extending from a horn or mountain peak, that separates glacial valleys or watersheds. | 11.3, Erosional Features in Alpine Glacier Environments | It appears as a narrow, sharp divide between two adjacent glacial valleys. |
| Horn | Sharp mountain peak carved after cirques and other erosional processes cut around a summit. | 11.3, Erosional Features in Alpine Glacier Environments | Cirques eroding around several sides of a summit leave a pointed apex. |
| Drumlin | Short streamlined hill shaped like an inverted spoon and used to infer the direction of advancing ice. | 11.3, Erosional and Depositional Features in Continental Glacier Environments | Low rolling hills around Waterloo Region form fields whose long axes record ice advance. |
| Terminus | End of a glacier below which released meltwater slows and commonly deposits sediment. | 11.3, Erosional and Depositional Features in Continental Glacier Environments | Below a receding ice-sheet front, slowing meltwater begins dropping its sediment load. |
